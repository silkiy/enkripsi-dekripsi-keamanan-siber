...
# ==========================================
# KONSTANTA TEMA WARNA (Modern Dark-Cyber)
# ==========================================
BG_DARK = "#090d16"          # Slate 950 (Sangat Gelap, latar belakang utama)
BG_CARD = "#1e293b"          # Slate 800 (Warna Latar Panel/Card)
BORDER_COLOR = "#334155"     # Slate 700 (Warna Batas/Border)
TEXT_PRIMARY = "#f8fafc"     # Slate 50 (Warna Teks Utama)
TEXT_MUTED = "#94a3b8"       # Slate 400 (Warna Teks Redup)

COLOR_INDIGO = "#6366f1"       # Indigo 500 (Warna Aksen Utama)
COLOR_INDIGO_HOVER = "#4f46e5" # Indigo 600
COLOR_TEAL = "#14b8a6"         # Teal 500 (Warna Aksen Sukses/Info)
COLOR_TEAL_HOVER = "#0d9488"   # Teal 600
COLOR_EMERALD = "#10b981"      # Emerald 500 (Warna Enkripsi)
COLOR_EMERALD_HOVER = "#059669"
COLOR_AMBER = "#f59e0b"        # Amber 500 (Warna Dekripsi)
COLOR_AMBER_HOVER = "#d97706"
COLOR_RED = "#ef4444"          # Red 500 (Warna Error/Peringatan)
...
class E2EEApp:
    ...
    def render_encrypt_message_view(self, parent):
        ...
        self.enc_char_count_lbl = ctk.CTkLabel(msg_card, text="Karakter: 0", text_color=TEXT_MUTED, font=("Segoe UI", 8))
        self.enc_char_count_lbl.pack(anchor="e", padx=20, pady=(6, 15))
        ...
        lbl_pub_tag = ctk.CTkLabel(key_section, text="Kunci Publik Penerima (.pem):", font=("Segoe UI", 10, "bold"), text_color=TEXT_PRIMARY)
        lbl_pub_tag.pack(anchor="w", pady=(0, 10))
    ...
    def render_encrypt_file_view(self, parent):
        ...
        lbl_src_tag = ctk.CTkLabel(file_section, text="Pilih Berkas Sumber (File Asli):", font=("Segoe UI", 10, "bold"), text_color=TEXT_PRIMARY)
        lbl_src_tag.pack(anchor="w", pady=(0, 10))
    ...
    def render_decrypt_message_view(self, parent):
        ...
        self.dec_char_count_lbl = ctk.CTkLabel(input_card, text="Karakter: 0", text_color=TEXT_MUTED, font=("Segoe UI", 8))
        self.dec_char_count_lbl.pack(anchor="e", padx=20, pady=(6, 15))
        ...
        lbl_priv_tag = ctk.CTkLabel(key_section, text="Kunci Privat Anda (.pem):", font=("Segoe UI", 10, "bold"), text_color=TEXT_PRIMARY)
        lbl_priv_tag.pack(anchor="w", pady=(0, 10))
    ...
    def render_decrypt_file_view(self, parent):
        ...
        lbl_src_tag = ctk.CTkLabel(file_section, text="Pilih Berkas Terenkripsi (.enc):", font=("Segoe UI", 10, "bold"), text_color=TEXT_PRIMARY)
        lbl_src_tag.pack(anchor="w", pady=(0, 10))
